...
LangString DESC_OpenERP_GTK_Client ${LANG_FRENCH} "Installation du Client OpenERP GTK Desktop si vous désirez accéder à OpenERP avec une application bureau."
...
Section $(TITLE_PostgreSQL) SectionPostgreSQL
    ...
    ExecWait 'msiexec /i \
        "$TEMP\postgresql-8.3-int.msi" /qn INTERNALLAUNCH=1 \
